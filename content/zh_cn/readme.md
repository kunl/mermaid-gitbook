...
> mermaid 美人鱼 就是为此而生，一个简单的 markdown-like 脚本语言，在 javascript 中通过文本来生成图表。 \[尝试一下在线编辑器吧\]\[[https://mermaidjs.github.io/mermaid-live-editor](https://mermaidjs.github.io/mermaid-live-editor)\]
